...
$stmt = $conn->prepare("INSERT INTO otp_verifications (user_id, email, otp, expires_at, verified) VALUES (?, ?, ?, ?, 0)");
$stmt->bind_param("isss", $user_id, $email, $hashed_otp, $expires_at);
